...
namespace RAM.Plugins.ColumnJointGP1
{
    ...
    {
        // === ПРИВАТНЫЕ ПОЛЯ (БАЗОВЫЕ НАСТРОЙКИ) ===
        ...
        public string SpliceBolt_Standard
        {
            ...
            set
            {
                ...
                RefreshSizes(value); // Запрос к внешнему сервису при изменении
            }
        }

        [StructuresDialog("SpliceBolt_Tol", typeof(TD.Double))]
        public double SpliceBolt_Tol { get => _spliceBolt_Tol; set => Set(ref _spliceBolt_Tol, value); }

        [StructuresDialog("SpliceBolt_W1", typeof(TD.Integer))]
        public int SpliceBolt_W1 { get => _spliceBolt_W1; set => Set(ref _spliceBolt_W1, value); }

        [StructuresDialog("SpliceBolt_W2", typeof(TD.Integer))]
        public int SpliceBolt_W2 { get => _spliceBolt_W2; set => Set(ref _spliceBolt_W2, value); }

        [StructuresDialog("SpliceBolt_W3", typeof(TD.Integer))]
        public int SpliceBolt_W3 { get => _spliceBolt_W3; set => Set(ref _spliceBolt_W3, value); }

        [StructuresDialog("SpliceBolt_N1", typeof(TD.Integer))]
        public int SpliceBolt_N1 { get => _spliceBolt_N1; set => Set(ref _spliceBolt_N1, value); }

        [StructuresDialog("SpliceBolt_N2", typeof(TD.Integer))]
        public int SpliceBolt_N2 { get => _spliceBolt_N2; set => Set(ref _spliceBolt_N2, value); }

        [StructuresDialog("SpliceBolt_Bolt", typeof(TD.Integer))]
        public int SpliceBolt_Bolt { get => _spliceBolt_Bolt; set => Set(ref _spliceBolt_Bolt, value); }

        // === МЕТОДЫ ОБНОВЛЕНИЯ UI (Вызывают внешний сервис) ===
